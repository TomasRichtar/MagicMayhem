    ...
    public class Q_InventoryMainEditorWindow : Q_InventoryEmptyEditorWindow
    {
        ...
        void InitializeReorderableList()
        {
            if (inventoryItemList.itemList != null)
                ...
                {
                    QInventory.Item obj = inventoryItemList.itemList[itemViewIndex - 1];
        ...
        void CreateNewItemList()
        {
            ...
            if (inventoryItemList)
            {
                inventoryItemList.itemList = new List<QInventory.Item>();
        ...
        void AddItem()
        {
            ...
            QInventory.Item newItem = CreateItem.Create();
        ...
        void DrawBluePrint()
        {
            ...
            if (inventoryItemList.bluePrints.Count > 0)
            {
                ...
                if (inventoryItemList.bluePrints.Count > 0)
                {
                    ...
                    GUILayout.Space(5);
                    //target
                    inventoryItemList.bluePrints[bluePrintViewIndex - 1].targetItem = EditorGUILayout.ObjectField("Product", inventoryItemList.bluePrints[bluePrintViewIndex - 1].targetItem, typeof(QInventory.Item), false) as QInventory.Item;
                    GUILayout.Space(5);
