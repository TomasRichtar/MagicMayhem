...
namespace KinematicCharacterController.Walkthrough.ChargingState
{
    ...
    public class MyCharacterController : MonoBehaviour, ICharacterController
    {
        ...
        public ProjectileGunTutorial SpellManager;

        [Header("Stable Movement")]
        private float StableMoveSpeed = 10f;
        public float MaxSprintStableMoveSpeed = 20f;
        public float MaxStableMoveSpeed = 20f;
        public float MinSprintStableMoveSpeed = 5f;
        public float MinStableMoveSpeed = 5f;
                ...
                case CharacterState.Charging:
                    {
                        ...
                        targetMovementVelocity = reorientedInput * AirJumpForce;
                        _currentChargeVelocity = reorientedInput * ChargeSpeed;
                        */
                ...
                case CharacterState.Default:
                    {
                        ...
                        if (moveInputVector.z < 0)
                        {
                            if (inputs.Sprint)
                            {
                                StableMoveSpeed = MinSprintStableMoveSpeed;
                            }
                            else
                            {
                                StableMoveSpeed = MinStableMoveSpeed;
                            }

                        }
                        else if (inputs.Sprint)
                        {
                            StableMoveSpeed = MaxSprintStableMoveSpeed;

                        }
                        else
                        {
                            StableMoveSpeed = MaxStableMoveSpeed;
                        }
                        // Jumping input
                        if (inputs.JumpDown)
                        {
                        ...
                        if (inputs.AbilityCast)
                        {
                            SpellManager.AbilityCast();
                        }
                        // Crouching input
                ...
                case CharacterState.Default:
                    {
                        ...
                        if (Motor.GroundingStatus.IsStableOnGround)
                        {
                            ...
                            targetMovementVelocity = reorientedInput * StableMoveSpeed;
                        ...
                        else
                        {
                            if (AllowAirMovement)
                            {
                                ...
                                {
                                    targetMovementVelocity = currentVelocity +_moveInputVector * MaxAirMoveSpeed;
